...
class SimpleTransformerDiffuser(torch.nn.Module):
    """
    ...
    def __init__(self, num_attention_heads=8, encoder_hidden_dim=16, encoder_dropout=0.1, encoder_activation="relu",
        ...
        super(SimpleTransformerDiffuser, self).__init__()

        print("Transformer Decoder No Struct with Point Transformer 6D All Objects")
    ...
    def forward(self, t, xyzs, obj_xyztheta_inputs,
                position_index):
        """
        ...
        Args:
            ...
            obj_xyztheta_inputs (torch.tensor of shape (Batch Size, Number of Objects, 9): Representing the transformations of objects
        ...
        xytheta_embed = self.position_encoder(obj_xyztheta_inputs)
        ...
        # start_token_embed = self.start_token_embeddings(start_token) # Is this needed?

        # tgt_obj_embed = torch.cat([start_token_embed, obj_pc_embed], dim=1)
        tgt_obj_embed = torch.cat([xytheta_embed, obj_pc_embed], dim=-1)
        ...
        tgt_position_embed = position_embed
